...
#include <BWTBuilder.h>
#include <mapper/MapperCont.h>
#include <IntSuffixSort.h>
...
namespace TextIndexes {
    ...
    uint *BWTBuilder::buildInternal(uint *input, size_t n, uint *&SA){
        ...
        integer_suffix_sort::IntSuffixSort<int> *ss = new integer_suffix_sort::IntSuffixSort<int>();
        ss->suffixsort(invA, psi, n, max_v+1,1);
