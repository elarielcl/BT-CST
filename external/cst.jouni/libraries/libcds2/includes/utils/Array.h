...
//			//returns a new array an set the parameter to null
//			static Array* copy(Array *&array){
//				Array *a = new Array();
//				a->bitsPerItem = array->bitsPerItem;
//				a->data = array->data;
//				a->maxValue = array->maxValue;
//				a->length = array->length;
//				a->uintLength = array->uintLength;
//				array = nullptr;
//				return a;
//			}
			/*destroys the access :-(
