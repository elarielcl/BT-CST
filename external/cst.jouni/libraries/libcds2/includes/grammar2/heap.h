...
typedef struct
  { Thnode_repair *freq; // space for all frequent nodes is preallocated, sqrt(u)
    int freef; // ptr to free list in freq
    Thfreq_repair *ff; // space for all frequencies of frequent nodes prealloc idem
...
void purgeHeap (Theap_repair *H); // remove elems with freq 1
