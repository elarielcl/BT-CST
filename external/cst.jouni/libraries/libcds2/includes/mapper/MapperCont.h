...
namespace cds_static
{
	...
	{
		public:
			MapperCont(const Array & seq, const BitSequenceBuilder & bsb, uint first=1);
			MapperCont(const uint * A, const size_t len, const BitSequenceBuilder & bsb, uint first=1);
