...
#ifndef MAPPING_WM_BLOCKS_BUILDER_H
#define MAPPING_WM_BLOCKS_BUILDER_H

namespace cds_static
{
	class MappingWMBlocksBuilder : public MappingWMBuilder
	{
		public:
			MappingWMBlocksBuilder();
			virtual ~MappingWMBlocksBuilder();
