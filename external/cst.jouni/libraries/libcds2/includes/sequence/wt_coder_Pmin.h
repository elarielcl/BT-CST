...
#ifndef wt_coder_Pmin_h
#define wt_coder_Pmin_h
...
namespace cds_static
{
     ...
     */
    class wt_coder_Pmin: public wt_coder_huff_can
    {
        public:
            /** Buils a wt_coder_Pmin using the sequence of length n and the alphabet_mapper
             *  to determine the huffman codes */
            wt_coder_Pmin(const Array & a, Mapper *am);
            wt_coder_Pmin(uint *symbs, size_t n, uint L, float minFreq, MappingBuilder *ms);
            wt_coder_Pmin(wt_coder_huff *wc, uint max_v, uint L, MappingBuilder *mb);
            wt_coder_Pmin(wt_coder_huff *wc, uint max_v, uint L, BitSequenceBuilder *);
            wt_coder_Pmin(wt_coder_huff *wc, uint max_v, float L);
            wt_coder_Pmin(uchar *symbs, size_t n, Mapper * am);
            wt_coder_Pmin(uint * symbs, size_t n, uint L, MappingBuilder *ms, ofstream &of);
            virtual ~wt_coder_Pmin();
           ...
           virtual void save(ofstream & fp) const;
            static wt_coder_Pmin * load(ifstream & fp);
