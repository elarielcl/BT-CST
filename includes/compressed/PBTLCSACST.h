//
// Created by elarielcl on 1/29/19.
//

#ifndef BLOCKTREE_PBTLCSA_H
#define BLOCKTREE_PBTLCSA_H
...
public:
    ...
    PBTLCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTLCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTLCSACST();
