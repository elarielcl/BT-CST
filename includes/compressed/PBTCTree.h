...
#ifndef BLOCKTREE_PBTCTREE_H
#define BLOCKTREE_PBTCTREE_H
...
public:
    ...
    PBTCTree(std::string&, int = PAPER, int = 2, int = 16, int = 2);
    ~PBTCTree();
    ...
    int lca(int, int);
    int child_rank(int);
    int child(int, int, int = -1, int = 3);
    int number_of_children(int, int = -1);
