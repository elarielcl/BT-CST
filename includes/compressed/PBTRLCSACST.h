//
// Created by elarielcl on 28/09/18.
//

#ifndef BLOCKTREE_PBTRLCSACST_H
#define BLOCKTREE_PBTRLCSACST_H
...
public:
    ...
    PBTRLCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTRLCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTRLCSACST();
