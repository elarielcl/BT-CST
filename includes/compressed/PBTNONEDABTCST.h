...
#ifndef BLOCKTREE_PBTNONEDABTCST_H
#define BLOCKTREE_PBTNONEDABTCST_H
...
public:
    ...
    PBTCISA* pbtcISA_;
    static const int disa_constant = 128;
    ...
    PBTNONEDABTCST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTNONEDABTCST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTNONEDABTCST();
...
#endif //BLOCKTREE_PBTNONEDABTCST_H
