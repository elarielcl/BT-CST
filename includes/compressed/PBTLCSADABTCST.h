...
#ifndef BLOCKTREE_PBTLCSADABTCST_H
#define BLOCKTREE_PBTLCSADABTCST_H
//
// Created by elarielcl on 1/30/19.
//
...
public:
    ...
    PBTCISA* pbtcISA_;
    static const int disa_constant = 16;
    ...
    PBTLCSADABTCST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTLCSADABTCST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTLCSADABTCST();
...
#endif //BLOCKTREE_PBTLCSADABTCST_H
