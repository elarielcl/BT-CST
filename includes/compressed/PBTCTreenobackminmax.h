...
#ifndef BLOCKTREE_PBTCTREENOBACKMINMAX_H
#define BLOCKTREE_PBTCTREENOBACKMINMAX_H
#include <compressed/BPSPCBlockTree.h>


class PBTCTreenobackminmax {
public:
    ...
    PBTCTreenobackminmax(std::string&, int = PAPER, int = 2, int = 16, int = 2);
    ~PBTCTreenobackminmax();
...
#endif //BLOCKTREE_PBTCTREENOBACKMINMAX_H
