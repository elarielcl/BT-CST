...
#ifndef BLOCKTREE_PBTDABTDABTCST_H
#define BLOCKTREE_PBTDABTDABTCST_H
//
...
public:
    ...
    PBTCSA* pbtcSA_;
    PBTCISA* pbtcISA_;
    static const int disa_constant = 8; // With saccess
    ...
    PBTDABTDABTCST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTDABTDABTCST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTDABTDABTCST();
...
#endif //BLOCKTREE_PBTDABTDABTCST_H
