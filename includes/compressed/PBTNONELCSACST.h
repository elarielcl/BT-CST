...
#ifndef BLOCKTREE_PBTNONELCSACST_H
#define BLOCKTREE_PBTNONELCSACST_H
...
public:
    ...
    PBTNONELCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTNONELCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTNONELCSACST();
...
#endif //BLOCKTREE_PBTNONELCSACST_H
