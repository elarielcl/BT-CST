...
#ifndef BLOCKTREE_PBTNOBACKRLCSACST_H
#define BLOCKTREE_PBTNOBACKRLCSACST_H
...
public:
    ...
    PBTnobackRLCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2);
    PBTnobackRLCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2);
    ~PBTnobackRLCSACST();
...
#endif //BLOCKTREE_PBTNOBACKRLCSACST_H
