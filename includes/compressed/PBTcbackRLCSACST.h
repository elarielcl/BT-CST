//
// Created by elarielcl on 11/30/18.
//

#ifndef BLOCKTREE_PBTCBACKRLCSACST_H
#define BLOCKTREE_PBTCBACKRLCSACST_H
...
public:
    ...
    PBTcbackRLCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2);
    PBTcbackRLCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2);
    ~PBTcbackRLCSACST();
...
#endif //BLOCKTREE_PBTCBACKRLCSACST_H
