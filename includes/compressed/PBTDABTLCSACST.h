...
#ifndef BLOCKTREE_PBTDABTLCSACST_H
#define BLOCKTREE_PBTDABTLCSACST_H
...
public:
    ...
    PBTDABTLCSACST(std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    PBTDABTLCSACST(std::string&, std::string&, int = PAPER, int = 2, int = 16, int = 2, int = 32, int = 128);
    ~PBTDABTLCSACST();
...
#endif //BLOCKTREE_PBTDABTLCSACST_H
